    ...
    <div class="row">
        ...
        <div class="col-6">
            <div class="mb-3">
                ...
                <input type="text" name="email" value="{{ old('email')}}" class="form-control email @error('email') is-invalid @enderror" id="" placeholder="Email...">
                @error('email')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
        ...
        <div class="col-6">
            <div class="mb-3">
                ...
                <input type="text" name="phone" value="{{old('phone')}}" class="form-control @error('phone') is-invalid @enderror" id="" placeholder="Số điện thoại...">
                @error('phone')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
